...
void inserirElemento(Pilha *topo){
  ...
  if(novoNo==nullptr){
    ...
    getline(cin, novoNo->dados.nome);

    cout << "Informe o cargo do funcionario: ";
    getline(cin, novoNo->dados.cargo);

    cout << "Informe o salario: ";
    cin >> novoNo->dados.salario;
...
void exibirElemento(Pilha *topo){
  if(pilhaVazia(topo)){
    ...
    cout << "Nome do funcionario: " << (*topo)->dados.nome;
    cout << "\nCargo: " << (*topo)->dados.cargo;
    cout << "\nSalario: " << (*topo)->dados.salario << "\n";
  }
}
